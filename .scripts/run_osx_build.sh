...
validate_recipe_outputs "terraform-provider-ovh-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-ovh-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi